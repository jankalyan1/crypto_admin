...
const GredientChart2 = () => {
  ...
  const optionsgredientchart = {
    ...
    annotations: {
      ...
      xaxis: [
        {
          x: new Date('16 Jan 2024').getTime(),
          borderColor: '#fff',
        },
      ],
    },
    ...
    const fetchData = async () => {
      ...
      try {
        const response = await axios.get(`https://rest.coinapi.io/v1/ohlcv/${symbolId}/history`, {
          params: {
            period_id: '12HRS',
            time_start: '2024-01-16T10:00:54.836Z',
            time_end: '2024-01-16T17:00:54.836Z',
            limit: 100,
          ...
          headers: {
            ...
            'X-CoinAPI-Key': '04F87819-A740-449D-B543-A1D1C544D603', // Replace with your actual API key
          },
        });
